...
public class AuthorityRuleController {
    ...
    @Autowired
    @Qualifier("XiaoQiangAuthorityRuleNacosProvider")
    private DynamicRuleProvider<List<AuthorityRuleEntity>> ruleProvider;

    @Autowired
    @Qualifier("XiaoQiangAuthorityRuleNacosPublisher")
    private DynamicRulePublisher<List<AuthorityRuleEntity>> rulePulisher;
