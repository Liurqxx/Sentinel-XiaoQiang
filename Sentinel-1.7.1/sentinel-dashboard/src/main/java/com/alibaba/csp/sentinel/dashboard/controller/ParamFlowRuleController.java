...
public class ParamFlowRuleController {
    ...
    @Autowired
    @Qualifier("XiaoQiangHotParamFlowRuleNacosProvider")
    private DynamicRuleProvider<List<ParamFlowRuleEntity>> ruleProvider;

    @Autowired
    @Qualifier("XiaoQiangHotParamFlowRuleNacosPublisher")
    private DynamicRulePublisher<List<ParamFlowRuleEntity>> rulePulisher;
